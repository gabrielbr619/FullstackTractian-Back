...
var CompanyController = /** @class */ (function () {
    ...
    CompanyController.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Company_1.default.find().populate("branch").populate("active").populate("user").then(function (data) { return res.send(data); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, company.save(function (err) {
                                if (err)
                                    return res.send(err);
    ...
    CompanyController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Company_1.default.deleteOne({ _id: req.params.id }, function (err) {
                            if (err)
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Company_1.default.find().then(function (data) { return res.send(data); })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Company_1.default.findOneAndUpdate(query, update)];
                    case 1:
                        _a.sent();
